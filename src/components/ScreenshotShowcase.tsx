...
const tabs: ScreenshotTab[] = [
  {
    id: 'dashboard',
    label: 'Dashboard',
    description: 'The central hub for managing your system packages.',
    detailedDescription: 'Unified card layout that groups the same package across Pacman, AUR, Flatpak, and AppImage. Easily install, update, or remove packages with simple, intuitive, one-click controls.',
    icon: LayoutDashboard,
    features: ['Multi-source grouping', 'Pacman integration', 'Flatpak support', 'One-click updates'],
    image: dashboardImg,
  },
  {
    id: 'details',
    label: 'Package Details',
    description: 'Deep-dive information on packages, versions, and dependencies.',
    detailedDescription: 'View descriptions, dependencies, build dates, maintainers, licensing, and file footprints directly in a structured overview before making changes to your system.',
    icon: BookOpen,
    features: ['Dependency mapping', 'Version history', 'License tracking', 'File footprints'],
    image: detailsImg,
  },
  {
    id: 'diskpage',
  ...
  },
  {
    id: 'terminal',
    label: 'Terminal Logs',
    description: 'Real-time installation console logs and AUR compilations.',
    detailedDescription: 'Monitor standard compilation output (makepkg) and transaction logs in real time. Perfect for power users who want complete visibility into what is running under the hood.',
    icon: Terminal,
    features: ['Real-time build logs', 'Pacman stdout wrapper', 'Scroll lock', 'Error highlighting'],
    image: terminalImg,
  },
  {
    id: 'apppanel',
    label: 'App Panel',
    description: 'Compact system overview and quick action panel.',
    detailedDescription: 'A lightweight control panel displaying active background operations, quick configuration toggles, and status updates for automated repository sync.',
    icon: Cpu,
    features: ['Compact control view', 'Sync background operations', 'Quick settings', 'Resource-friendly'],
    image: apppanelImg,
  },
];
